...
Version  : 0.99.34
Release  : 5
URL      : https://github.com/alexpevzner/sane-airscan/archive/0.99.34/sane-airscan-0.99.34.tar.gz
Source0  : https://github.com/alexpevzner/sane-airscan/archive/0.99.34/sane-airscan-0.99.34.tar.gz
...
%prep
%setup -q -n sane-airscan-0.99.34
cd %{_builddir}/sane-airscan-0.99.34
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744748216

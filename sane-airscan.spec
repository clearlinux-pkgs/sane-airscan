...
Source0  : https://github.com/alexpevzner/sane-airscan/archive/0.99.32/sane-airscan-0.99.32.tar.gz
...
%prep
%setup -q -n sane-airscan-0.99.32
cd %{_builddir}/sane-airscan-0.99.32
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738165809

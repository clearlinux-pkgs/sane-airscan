...
Source0  : https://github.com/alexpevzner/sane-airscan/archive/0.99.35/sane-airscan-0.99.35.tar.gz
...
%prep
%setup -q -n sane-airscan-0.99.35
cd %{_builddir}/sane-airscan-0.99.35
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746027541
